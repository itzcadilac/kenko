      ...
      <nav class="navbar navbar-expand-lg navbar-light p-0">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent" aria-hidden="true">
            <ul class="navbar-nav ml-auto navbar-list">
               ...
               <li class="nav-item">
                           <a class="search-toggle iq-waves-effect language-title" href="#" target="_blank"><img src="<?=base_url()?>public/images/flag-01.png" alt="img-flaf" class="img-fluid mr-1" style="height: 30px; width: 30px;" />  </a>
