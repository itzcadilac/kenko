...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?=base_url()?>public/css/inventario/main.css" />
       <?php $titulo = "Lista General de Tipos de Hospitales Registradas"; ?>
   ...
   <body>
                           ...
                           <div class="form-group row">
                            <div class="col-sm-12 col-md-5 col-md-offset-5 pa-10">
                                <button type="button" class="btn btn-primary btn-nuevo" data-toggle="modal" id="btnRegistrar">
                                  ...
                                  Registrar Nuevo Tipo de Hospital
                                </button>
                            </div>
                           </div>
                           <div class="table-responsive">
                              <table id="dt-select" class="table table-striped table-bordered">
                                 <thead>
                                  <tr>
                                    <th>Editar</th>
                                    <th>Descripción de Tipo de Hospital</th>
                  ...
                  <div class="modal-content">
                    ...
                    <form id="formRegistrar">
                      <div class="modal-body">
                        ...
                        <div class="col-xs-12">					
                          <div class="form-group row">
                            <label class="modal-label col-sm-5">Fecha Baja</label>
                            <div class="col-sm-7">
                              <div class="form-group" id="error_fecha_baja">
                                <div class='input-group'>
                                  <input type="date" class="form-control" name="fecha_baja" id="fecha_baja"  max="<?= date("Y-m-d") ?>"/> 
                                </div>
                              </div>
                            </div>
                          </div>
      ...
      <script>
        ...
        var listatipoHospital = JSON.parse('<?=$listatipoHospital?>');
      </script>
      <script src="<?=base_url()?>public/js/inventarios/tipohospital.js?v=<?=date(" his")?>"></script>
   </body>
</html>