            ...
            <div class="container-fluid">
                  ...
                  <div class="modal-content">
                    ...
                    <form id="formRegistrar">
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <h2 class="text-divider"><span>Datos del Artículo</span> <button type="button" class="btn btn-primary btn-buscainv">Buscar Inventario</button> </h2> 
                          </div>
                          <div class="col-sm-4">
                            <div class="row">
                          ...
                          <div class="col-sm-4">
                            <div class="row">
                              <label class="modal-label col-sm-12 col-form-label py-10">Código de Bien</label>
                              <div class="col-sm-12">
                          ...
                          <div class="col-sm-4">
                            <div class="row">
                              <label class="modal-label col-sm-12 col-form-label py-10">Código Patrimonial de Componente</label>
                              <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                <div class='input-group'>
                                  <input type="date" class="form-control" name="fechaRegistro" id="fechaRegistro"  max="<?= date("Y-m-d") ?>"/>
                                </div>
                              </div>
                            </div>
                            </div>
                          ...
                          <div class="col-sm-4">
                            <div class="row">
                              ...
                              <div class="col-sm-12">
                                <input type="date" class="form-control" name="fecCompra" id="fecCompra" max="<?= date("Y-m-d") ?>"/>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-4">
                          ...
                          <div class="col-sm-4">
                            <div class="row">
                              <label class="modal-label col-sm-12 col-form-label py-10">Código Inventario</label>
                              <div class="col-sm-12">
                          ...
                          <div class="col-sm-4">
                            <div class="row">
                              <label class="modal-label col-sm-12 col-form-label py-10">Tipo de Hospital</label>
                              <div class="col-sm-12">
                                  <select class="form-control" name="tipohospital" id="tipohospital">
                                    <option value="">-- Tipo Hospital --</option>
                                    <?php foreach($listaTipoHospital as $row): ?>
                                    <option value="<?=$row->idtipohospital?>"><?=$row->descripcion?></option>
                                    <?php endforeach; ?>
                                  </select>
                              </div>
                            </div>
              ...
              <div class="modal fade" id="tableArticulo" tabindex="-1" role="dialog" aria-labelledby="tableArticuloLabel" aria-hidden="false" style="z-index: 1600;">
                <div class="modal-dialog modal-lg" role="document" style="padding-top: 10px;">
                  ...
                  <div class="table-responsive">
                    <table
                      class="tableArticulo table table-striped table-bordered" cellspacing="0.5" width="100%">
                      <thead>
                        <tr>
                          <th>Código SIGA</th>
              ...
              <div class="modal fade" id="tableArticuloInv" tabindex="-1" role="dialog" aria-labelledby="tableArticuloInvLabel" aria-hidden="false" style="z-index: 1600;">
                <div>
                  <div class="modal-dialog modal-lg" role="document" style="padding-top: 10px;">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="registrarTableroModalLabel">Seleccionar Artículo Inventariada</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="table-responsive">
                      <table class="tableArticuloInv table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <th>Descripción</th>
                            <th>Marca</th>
