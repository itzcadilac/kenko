                    ...
                    <form id="formRegistrar">
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Dirección Domiciliaria</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Código Ubigeo</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                                    <input type="text" class="form-control" name="codigoUbigeo" id="codigoUbigeo" readonly="readonly"/>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Nombre Ubigeo</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                                    <input type="text" class="form-control" name="nombreUbigeo" id="nombreUbigeo" readonly="readonly"/>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Numero DNI</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div class="input-group" id="error_numero_documento">
                                    <input type="text" class="form-control" name="numeroDniTitular" id="numeroDniTitular" maxlength="8"/>
                                    <button type="button" id="btnBuscarTitular" class="btn btn-search"><i class="fa fa-search" aria-hidden="true"></i></button>
                                  </div>
                                  <label id="numeroDniTitular-error" class="error" for="numeroDniTitular"></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Nombre Completo</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                                    <input type="text" class="form-control" name="nombreTitular" id="nombreTitular" readonly="readonly"/>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group row">
                              <label class="modal-label col-sm-5">Teléfono Contacto</label>
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div class="input-group" id="error_numero_documento">
                                    <input type="text" class="form-control" name="numeroDniSuplente" id="numeroDniSuplente" maxlength="8"/>
                                    <button type="button" id="btnBuscarSuplente" class="btn btn-search"><i class="fa fa-search" aria-hidden="true"></i></button>
                                  </div>
                                  <label id="numeroDniSuplente-error" class="error" for="numeroDniSuplente"></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="form-group">
                                  <div>
                                    <input type="text" class="form-control" name="nombreSuplente" id="nombreSuplente" readonly="readonly"/>
                                  </div>
                                </div>
                              </div>
                            </div>
