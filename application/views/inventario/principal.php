                              ...
                              <div class="row col-sm-12">
                                  ...
                                  <div class="col-sm-3">
                                    <div class="form-group row">
                                      <label class="col-sm-4 col-form-label py-10">Artículos por Clasificación</label>
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" value="<?=($idClasificacion > 0)? $totalClasificacion : $total?>" disabled>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-3">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                          <select class="form-control" name="idClasificacion" id="idClasificacion">
                                            ...
                                            <option value="<?=$row->idclasificacion?>" <?=($row->idclasificacion==$idClasificacion)?"selected":""?>><?=$row->descripcion?></option>
                                            <?php endforeach; ?>
                                          </select>
                                        </div>
                                      </div>
                       ...
                       <div class="iq-card">
                          <div class="iq-card-body text-center">
                             <div class="doc-profile">
                                <img class="rounded-circle img-fluid avatar-80" src="<?=base_url()?>public/inventarios/fotos/<?=$row->imagen?>" alt="picture">
                             </div>
