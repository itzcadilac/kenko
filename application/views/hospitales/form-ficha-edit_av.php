                     ...
                     <div class="iq-card"> 
                        ...
                        <div class="iq-card-body">
                           <form id="formHospital" name="formHospital" method="POST" action="" autocomplete="off">
                              ...
                              <h4 class="text-divider"><span>Jefe de Guardia (Supervisor)</span></h4>
                              <br>
                              ...
                              <div class="tab-content" id="myTabContent-2">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="hospitalizacion_convencionales_o" id="hospitalizacion_convencionales_o" value="<?=$hospital->hospitalizacion_convencionales_o?>" /> 
                                             </div>
                                          </div>

                                          <label class="span__bold">CAMAS HABILITADAS PARA HOSPITALIZACIÓN NO COVID 19</label>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label>Observaciones: </label>
                                                <input type="text" class="form-control" name="hospitalizacion_covid_o" id="hospitalizacion_covid_o" value="<?=$hospital->hospitalizacion_covid_o?>" /> 
                                             </div>
                                          </div>



                                          <label class="span__bold">CAMAS HABILITADAS PARA HOSPITALIZACIÓN COVID 19 , EN EXPANSIÓN INTERNA</label>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label>Observaciones: </label>
                                                <input type="text" class="form-control" name="hospitalizacion_e_interna_o" id="hospitalizacion_e_interna_o" value="<?=$hospital->hospitalizacion_e_interna_o?>" /> 
                                             </div>
                                          </div>



                                          <label style="display:block; width:100%" class="span__bold">CAMAS HABILITADAS PARA HOSPITALIZACIÓN COVID 19 EXPANSIÓN EXTERNA</label>
                                             (Incluye camas en áreas de expansión interna o externa en otros EESS o Nosocomios y/o áreas de expansión convertidas para Hospitalización NO COVID 19)
                                          <div class="col-md-3">
                                             <div class="form-group">
                                                <label>Habilitada: </label>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label>Observaciones: </label>
                                                <input type="text" class="form-control" name="hospitalizacion_e_externa_o" id="hospitalizacion_e_externa_o" value="<?=$hospital->hospitalizacion_e_externa_o?>" /> 
                                             </div>
                                          </div>
                                          ...
                                          <div style="width:20%;">
                                             <div class="form-group">
                                                <label>CAMAS HOSPITALARIAS COVID 19 DISPONIBLES AL MOMENTO</label>
                                                <input type="number" class="form-control" name="hospitalizacion_disponibles_momento" id="hospitalizacion_disponibles_momento" value="<?=$hospital->hospitalizacion_disponibles_momento?>" readonly/> 
                                             </div>
                                          </div>
                                          <div style="width:20%;">
                                             <div class="form-group">
                                          ...
                                          <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS DE HOSPITALIZACIÓN ENTRE NUMERO DE MEDICOS POR TURNO</label>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="hospitalizacion_camas_01" id="hospitalizacion_camas_01" value="<?=$hospital->hospitalizacion_camas_01?>" /> 
                                             </div>
                                          </div>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                             <label>Personal: </label>
                                             <input type="number" class="form-control" name="hospitalizacion_medicos_01" id="hospitalizacion_medicos_01" value="<?=$hospital->hospitalizacion_medicos_01?>" /> 
                                             </div>
                                          </div>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="hospitalizacion_observaciones_01" id="hospitalizacion_observaciones_01" value="<?=$hospital->hospitalizacion_observaciones_01?>" /> 
                                             </div>
                                          </div>
                                          ...
                                          <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS DE HOSPITALIZACIÓN ENTRE NÚMERO DE PERSONAL DE ENFERMERÍA POR TURNO </label>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="hospitalizacion_camas_02" id="hospitalizacion_camas_02" value="<?=$hospital->hospitalizacion_camas_02?>" /> 
                                             </div>
                                          </div>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                             <label>Personal: </label>
                                             <input type="number" class="form-control" name="hospitalizacion_enfermeras_02" id="hospitalizacion_enfermeras_02" value="<?=$hospital->hospitalizacion_enfermeras_02?>" /> 
                                             </div>
                                          </div>
                                          <div class="col-md-3">
                                             <div class="form-group">
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group">
                                                <label>Observacion: </label>
                                                <input type="text" class="form-control" name="hospitalizacion_observaciones_02" id="hospitalizacion_observaciones_02" value="<?=$hospital->hospitalizacion_observaciones_02?>" /> 
                                             </div>
                                          </div> 
                                 ...
                                 <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab-2">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_convencionales_o" id="emergencia_convencionales_o" value="<?=$hospital->emergencia_convencionales_o?>" /> 
                                          </div>
                                       </div>

                                       <label class="span__bold">CAMAS HABILITADAS PARA EMERGENCIA ADULTOS PARA NO COVID 19</label>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_covid_o" id="emergencia_covid_o" value="<?=$hospital->emergencia_covid_o?>" /> 
                                          </div>
                                       </div>
                                       ...
                                       <!-- nuevo campo-->
                                       <label class="span__bold">CAMAS HABILITADAS PARA PACIENTE NO CRÍTICO COVID 19 EN EL SERVICIO DE EMERGENCIA ADULTO,COMO EXPANSIÓN INTERNA</label>
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Habilitada: </label>
                                          <input type="number" class="form-control" name="emergencia_e_externa_02_h" id="emergencia_e_externa_02_h" value="<?=$hospital->emergencia_e_externa_02_h?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Uso: </label>
                                          <input type="number" class="form-control" name="emergencia_e_externa_02_u" id="emergencia_e_externa_02_u" value="<?=$hospital->emergencia_e_externa_02_u?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_e_externa_o_03" id="emergencia_e_externa_o_03" value="<?=$hospital->emergencia_e_externa_o_03?>" /> 
                                          </div>
                                       </div>
                                       ...
                                       <label class="span__bold">CAMAS HABILITADAS PARA EMERGENCIA ADULTO COVID 19 , EN EXPANSIÓN INTERNA</label>
                                       (Convertidos para COVID 19; considerar camas que se tuvo que ampliar en espacios del servicios de emergencia como Cirugía, Traumatologia, etc; a cargo del servicio de Emergencia)
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Habilitada: </label>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_e_interna_o" id="emergencia_e_interna_o" value="<?=$hospital->emergencia_e_interna_o?>" /> 
                                          </div>
                                       </div>
                                       ...
                                       <label class="span__bold">CAMAS HABILITADAS PARA EMERGENCIAS ADULTOS COVID 19  EN EXPANSIÓN EXTERNA</label> 
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_e_externa_o" id="emergencia_e_externa_o" value="<?=$hospital->emergencia_e_externa_o?>" /> 
                                          </div>
                                       </div>
                                             ...
                                             <!-- nuevo campo-->
                                             <label class="span__bold">CAMAS HABILITADAS PARA PACIENTE CRÍTICO COVID 19 EN EL SERVICIO DE EMERGENCIA ADULTO (PACIENTE VENTILADO, COMO EXPANSIÓN EXTERNA)</label>
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Habilitada: </label>
                                          <input type="number" class="form-control" name="emergencia_e_externa_03_h" id="emergencia_e_externa_03_h" value="<?=$hospital->emergencia_e_externa_03_h?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Uso: </label>
                                          <input type="number" class="form-control" name="emergencia_e_externa_03_u" id="emergencia_e_externa_03_u" value="<?=$hospital->emergencia_e_externa_03_u?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="text" class="form-control" name="emergencia_e_externa_03_o" id="emergencia_e_externa_03_o" value="<?=$hospital->emergencia_e_externa_03_o?>" /> 
                                          </div>
                                       </div>


                                       <label class="span__bold">PACIENTES EN ESPERA DE CAMAS QUE REQUIEREN HOSPITALIZACION</label>
                                       ...
                                       <label class="span__bold">PACIENTES EN ESPERA DE CAMAS QUE REQUIEREN HOSPITALIZACION EN AREAS DE COVID 19</label>
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Uso: </label>
                                          <input type="number" class="form-control" name="emergencia_pacientes_02" id="emergencia_pacientes_02" value="<?=$hospital->emergencia_pacientes_02?>" /> 
                                          </div>
                                       </div>
                                          <div class="col-md-6">
                                          <div class="form-group">
                                       ...
                                       <div style="width:20%;">
                                          <div class="form-group">
                                          <label>CAMAS HOSPITALARIAS DISPONIBLES AL MOMENTO</label>
                                          <input type="number" class="form-control" name="emergencia_espera_u" id="emergencia_espera_u" value="<?=$hospital->emergencia_espera_u?>" readonly/> 
                                          </div>
                                       </div>

                                       <div style="width:20%;">
                                          <div class="form-group">
                                          <label>CAMAS PARA ATENCIÓN COVID 19 EN EMERGENCIAS DISPONIBLES AL MOMENTO</label>
                                          <input type="number" class="form-control" name="emergencia_espera_u_momento" id="emergencia_espera_u_momento" value="<?=$hospital->emergencia_espera_u_momento?>" value="0" readonly/> 
                                          </div>
                                       </div>
                                       ...
                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS DE EMERGENCIA ENTRE NUMERO DE MEDICOS POR TURNO </label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="emergencia_camas_01" id="emergencia_camas_01" value="<?=$hospital->emergencia_camas_01?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Personal: </label>
                                          <input type="number" class="form-control" name="emergencia_medicos_01" id="emergencia_medicos_01" value="<?=$hospital->emergencia_medicos_01?>" /> 
                                          </div>
                                       </div>
                                          <div class="col-md-3">
                                          <div class="form-group">
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="emergencia_observaciones_01" id="emergencia_observaciones_01" value="<?=$hospital->emergencia_observaciones_01?>"  /> 
                                          </div>
                                       </div>



                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS DE EMERGENCIA ENTRE NÚMERO DE PERSONAL DE ENFERMERÍA POR TURNO  </label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="emergencia_camas_02" id="emergencia_camas_02" value="<?=$hospital->emergencia_camas_02?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Personal: </label>
                                          <input type="number" class="form-control" name="emergencia_enfermeras_02" id="emergencia_enfermeras_02" value="<?=$hospital->emergencia_enfermeras_02?>" /> 
                                          </div>
                                       </div>
                                          <div class="col-md-3">
                                          <div class="form-group">
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="emergencia_observaciones_02" id="emergencia_observaciones_02" value="<?=$hospital->emergencia_observaciones_02?>" /> 
                                          </div>
                                       </div>
                                 ...
                                 <div class="tab-pane fade  " id="tab3" role="tabpanel" aria-labelledby="tab-3">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_convencionales_o" id="criticos_convencionales_o" value="<?=$hospital->criticos_convencionales_o?>" /> 
                                          </div>
                                       </div>

                                       <label class="span__bold">CAMAS HABILITADAS PARA UCI Adulto NO COVID 19</label>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_covid_o" id="criticos_covid_o" value="<?=$hospital->criticos_covid_o?>" /> 
                                          </div>
                                       </div>


                                       <!-- nuevo campo-->
                                       <label class="span__bold">CAMAS HABILITADAS PARA UCI Adulto COVID 19 , EN EXPANSIÓN INTERNA</label>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_e_interna_o" id="criticos_e_interna_o" value="<?=$hospital->criticos_e_interna_o?>" /> 
                                          </div>
                                       </div>
                                       ...
                                       <label class="span__bold">CAMAS HABILITADAS PARA UCI Adulto COVID 19, EN EXPANSIÓN EXTERNA</label>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_e_externa_o" id="criticos_e_externa_o" value="<?=$hospital->criticos_e_externa_o?>" /> 
                                          </div>
                                       </div>

                                       <label class="span__bold">PACIENTES NO COVID CON NECESIDAD DE SERVICIOS DE UCI</label> 
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_espera_o" id="criticos_espera_o" value="<?=$hospital->criticos_espera_o?>"  /> 
                                          </div>
                                       </div>
                                       ...
                                       <label class="span__bold">PACIENTES COVID - 19 CON NECESIDAD DE SERVICIOS DE UCI</label>
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Uso: </label>
                                          <input type="number" class="form-control" name="criticos_espera_u_momento" id="criticos_espera_u_momento" value="<?=$hospital->criticos_espera_u_momento?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                          <label>Observaciones: </label>
                                          <input type="number" class="form-control" name="criticos_espera_u_momento_o" id="criticos_espera_u_momento_o" value="<?=$hospital->criticos_espera_u_momento_o?>" /> 
                                       ...
                                       <div style="width:20%">
                                          ...
                                          <br>
                                          <input type="number" class="form-control" name="criticos_disponibles_momento" id="criticos_disponibles_momento" value="<?=$hospital->criticos_disponibles_momento?>" readonly/> 
                                          </div>
                                       </div>
                                       ...
                                       <div style="width:20%">
                                          ...
                                          <div style="width:20%">
                                          <div class="form-group">
                                          <label>SOBRESATURACIÓN DEL SERVICIO DE CUIDADOS CRITICOS ADULTOS: </label>
                                       ...
                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS UCI  ENTRE NUMERO DE MEDICOS POR TURNO</label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="criticos_camas_01" id="criticos_camas_01" value="<?=$hospital->criticos_camas_01?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Personal: </label>
                                          <input type="number" class="form-control" name="criticos_medicos_01" id="criticos_medicos_01" value="<?=$hospital->criticos_medicos_01?>" /> 
                                          </div>
                                       </div>
                                          <div class="col-md-3">
                                          <div class="form-group">
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="criticos_observaciones_01" id="criticos_observaciones_01" value="<?=$hospital->criticos_observaciones_01?>" /> 
                                          </div>
                                       </div>



                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS UCI ENTRE NÚMERO DE PERSONAL DE ENFERMERÍA POR TURNO  </label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                                <input type="number" class="form-control" name="criticos_camas_02" id="criticos_camas_02" value="<?=$hospital->criticos_camas_02?>" /> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Personal: </label>
                                          <input type="number" class="form-control" name="criticos_enfermeras_02" id="criticos_enfermeras_02" value="<?=$hospital->criticos_enfermeras_02?>" /> 
                                          </div>
                                       </div>
                                          <div class="col-md-3">
                                          <div class="form-group">
                                       ...
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="criticos_observaciones_02" id="criticos_observaciones_02" value="<?=$hospital->criticos_observaciones_02?>" /> 
                                          </div>
                                       </div>
                                 ...
                                 <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab-4">
                                    ...
                                    <div class="row">
                                       ...
                                       <label class="span__bold">CAMAS HABILITADAS PARA UCI Pediatrico NO COVID 19</label>
                                       (Considerar en EESS o Nosocomios convertidos para la Unidad de Cuidados Intensivos NO COVID 19; fuera de la institución)  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Habilitada: </label>
                                       ...
                                       <!-- nuevo campo-->
                                       <label class="span__bold">CAMAS HABILITADAS PARA UCI Pediatrico COVID 19 , EN EXPANSIÓN INTERNA</label>
                                       (Pabellones convertidos para UCI COVID 19; considerar camas que se tuvieron que ampliar para unidades de UCI COVID, por ejemplo de Cirugía, Cardiología, Traumatologia, etc)
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label>Habilitada: </label>
                                       ...
                                       <label class="span__bold">CAMAS HABILITADAS PARA HOSPITALIZACIÓN COVID 19  EXPANSIÓN EXTERNA</label>
                                       ...
                                       <label class="span__bold">PACIENTES PEDIATRICOS NO COVID CON NECESIDAD DE SERVICIOS DE UCI</label> 
                                       (Considerar pacientes que requieren de los servicios de UCI;  en espera de cama procedentes del Servicio de Emergencia u hospitalización)
                                       <div class="col-md-3">
                                          <div class="form-group">
                                          <label></label>
                                       ...
                                       <label class="span__bold">PACIENTES PEDIATRICOS COVID - 19 CON NECESIDAD DE SERVICIOS DE UCI</label>
                                       ...
                                       <div style="width:20%;">
                                          <div class="form-group">
                                          <label>CAMAS UCI PEDIATRICO DISPONIBLES AL MOMENTO</label>
                                       ...
                                       <div style="width:20%;">
                                          <div class="form-group">
                                          <label>CAMAS UCI PEDIATRICOS COVID 19 DISPONIBLES AL MOMENTO</label>
                                          <input type="number" class="form-control" name="pediatricos_disponibles_momento" id="pediatricos_disponibles_momento" value="0" readonly/> 
                                          </div>
                                       </div>
                                       ...
                                       <div style="width:20%;">
                                          ...
                                          <div style="width:20%;">
                                          <div class="form-group">
                                          <label>SOBRESATURACIÓN CUIDADOS CRITICOS PEDIATRICOS: </label>
                                       ...
                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS UCI PEDIÁTRICA ENTRE NUMERO DE MEDICOS POR TURNO</label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="form-group">
                                             <label>Indicador: </label>
                                             <input type="text" class="form-control" name="pediatricos_indicador_01" id="pediatricos_indicador_01" value="" readonly/> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="pediatricos_observaciones_01" id="pediatricos_observaciones_01" value="" /> 
                                          </div>
                                       </div>



                                       <label class="span__bold" style="display:block; width:100%">RELACION DEL NUMERO DE CAMAS UCI  PEDIÁTRICA ENTRE NÚMERO DE PERSONAL DE ENFERMERÍA POR TURNO  </label>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                                <label>Cama: </label>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="form-group">
                                             <label>Indicador: </label>
                                             <input type="text" class="form-control" name="pediatricos_observaciones_02" id="pediatricos_observaciones_02" value="" readonly/> 
                                          </div>
                                       </div>
                                       <div class="col-md-3">
                                          <div class="form-group">
                                             <label>Observacion: </label>
                                             <input type="text" class="form-control" name="ucipediatricros_camahosp_obser" id="ucipediatricros_camahosp_obser" value="" /> 
                                          </div>
                                       </div>
                              ...
                              <center>     <button type="submit" class="col-3 btn btn-primary">Guardar Registro </button></center>
