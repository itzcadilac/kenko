...
<head>
  ...
  <?php $titulo = "Registro de Salidas de PF - EPP - MM"; ?>
...
<body>
  ...
  <div class="wrapper">
    ...
    <div id="content-page" class="content-page">
      ...
      <div class="container-fluid">
        ...
        <div class="modal fade modal-fullscreen" id="editarModal" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form id="formRegistrarSalida" method="post" action="" autocomplete="off">
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            <div>
                              <input type="text" class="form-control" name="renipress" id="renipress"
                                readonly="readonly" />
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            <div>
                              <input type="text" class="form-control" name="tipoSalud" id="tipoSalud"
                                readonly="readonly" />
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-2">
                      ...
                      <button type="button" class="btn btn-primary col-sm-12" id="btnBuscarRenipress"
                        data-toggle="modal" data-target="#tableEntidadesSaludModal">Buscar</button>
                    </div>
                    <div class="col-sm-4">
                            <div class="row">
                          ...
                          <div class="col-sm-12">
                            <div class="row">
                              <label class="modal-label col-sm-12 col-form-label py-10">Otras Actividades DIGERD</label>
                              <div class="col-sm-12">
                                <div class="form-group">
                                  <div>
                                    <input type="text" class="form-control" name="otrasactividadesdigerd" id="otrasactividadesdigerd"/>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <div class="form-group row">
                    <label class="col-sm-12 col-form-label py-10"> &nbsp; </label>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <button type="button" class="btn btn-primary col-sm-12 btn-buscar" disabled>Agregar
                        Artículo</button>
                    </div>
                  </div>
                  <br/>
        ...
        <div class="modal fade" id="tableArticuloModal" tabindex="-1" role="dialog" aria-labelledby="tableArticuloLabel"
          aria-hidden="false" style="z-index: 1600;">
              ...
              <form id="formArticuloRegistrar">
                <div class="modal-body">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group row">
                        <label class="modal-label col-sm-5 col-form-label py-10">Caja</label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="caja" id="caja" value="" />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <input type="number" class="form-control" name="costo_unitario" id="costo_unitario"
                            value="" />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group row">
                        <label class="modal-label col-sm-5 col-form-label py-10">Observaciones</label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="observacionArticulo" id="observacionArticulo"
                            value="" />
                        </div>
                      </div>
                    </div>
          ...
          <div class="modal-dialog modal-lg" role="document" style="padding-top: 10px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <table class="tableEntidadesSalud table table-striped table-bordered table-sm" cellspacing="0"
                  width="100%">
                  <thead>
                    <tr>
                      <th>C&oacute;digo</th>
  ...
  <script src="<?=base_url()?>public/js/farmacia/initMap.js"></script>
  <script src="<?=base_url()?>public/js/farmacia/salidas.js?v=<?=date(" his")?>"></script>
