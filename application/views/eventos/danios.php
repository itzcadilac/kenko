...
<body>
		...
		<div id="content-page" class="content-page">
		  <?php $this->load->view("inc/nav-top-template");?>	
			...
			<div class="container-fluid">
																	...
																	<div id="message" class="col-xs-12"></div>
																		...
																		<div class="clearfix"></div>
																			...
																			<ul class="enlaces-otros">
																				...
																				<li><a href="javascript:;" class="enlaceFiles" rel="fileseventos">Repositorio de Archivos</a><span><i class="fa fa-file-o addFiles"></i></span></li>
																		...
																		<div class="col-xs-12">
																			<a class="a-danios" data-toggle="modal"	data-target="#daniosModal">No hay datos de da&ntilde;os. Click para registrar da&ntilde;os</a>
																		</div>
																		<div class="clearfix"></div>
																			<?php
																			} else {
																			?>
																		<div class="col-xs-12">
																			<button class="btn btn-primary" data-toggle="modal" data-target="#daniosModal">Registrar nueva actualizaci&oacute;n</button>
																		</div>
																			<?php
																			$n = 0;
				...
				<div class="modal fade" id="daniosModal" tabindex="-1" role="dialog" aria-labelledby="daniosModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="daniosModalLabel">Ingresar Datos de	Da&ntilde;os Generales</h4>
	...
	<script> danios("<?=base_url()?>","<?=$Evento_Registro_Numero?>"); </script>
</body>
